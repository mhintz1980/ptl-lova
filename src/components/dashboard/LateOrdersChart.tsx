...
export const LateOrdersChart: React.FC<LateOrdersChartProps> = ({
  pumps,
  headless,
  onDrilldown,
}) => {
        ...
        <BarChart
          ...
          onClick={(data) => {
            ...
            if (
              ...
              chartData.activePayload[0]
            ) {
              const stage = chartData.activePayload[0].payload
                .displayName as Stage
              onDrilldown({ stage })
            }
          }}
        >
...
export const LateOrdersChartWrapper: React.FC<ChartProps> = ({
  filters,
  onDrilldown,
}) => {
