...
export function ManifestItem({ pump, onReopen, onClick }: ManifestItemProps) {
  return (
    <div
      ...
      className="group relative flex items-center justify-between rounded-md border border-border/40 bg-card/40 px-3 py-2 text-xs transition-colors hover:bg-card cursor-pointer"
    >
